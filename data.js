...
// cycle: 'all' (every cycle) or a number (1, 2, 3) if the item is only needed for one specific cycle
const KIT_DATA = {
  "countries": [
    {
      "id": "south-africa",
  ...
  "items": {
    "south-africa": [
      ...
      },
      {
        ...
        "subcategory": "firstaid",
        "cycle": "all",
        "description": "Bring enough for the full expedition plus two extra weeks in case of travel delays or lost/damaged medication. Let the Expedition Team know in advance if you're taking prescription medication."
      },
      {
        "item": "Scissors",
        "quantity": "1",
      ...
      },
      {
        ...
        "subcategory": "clothing",
        "cycle": 2,
        "description": "Warm gloves needed only for the cooler cycle."
      },
      {
